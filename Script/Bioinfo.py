...
def N_counter(sequence: str) -> int:
	'''Function counts the total number of N's in the sequence DNA string (indicating unknown base call), and returns an integer value'''
